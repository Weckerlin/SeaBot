...
namespace SeaBotCore.Data.Definitions
{
    ...
    public partial class Item
    {
        ...
        [J("unlocked_locations", NullValueHandling = N.Ignore)] public UnlockedLocations UnlockedLocations { get; set; }
        [J("required_locations", NullValueHandling = N.Ignore)] public RequiredLocations RequiredLocations { get; set; }
    }
    ...
    {
        [J("type")]                                             public string Type { get; set; }
        [J("ids")][JsonConverter(typeof(ParseStringConverter))] public long Ids { get; set; }   
    }
